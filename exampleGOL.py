...
def gen(area = None):
    ...
    # as it can have values > 1 for long living cells
    # which is used to color the long living one 
...
def main():
    # global (for now) to minimize the parameters passed to functions
    ...
    try:
        ...
        # in case of problems roll back to defaults
        sizeX = 200 // 4
        sizeY = 100 // 4
    ...
    # splitting the world array to smaller pieces for analysis piece by piece 
    ...
    while True:
        ...
        # drawing the current world status 
